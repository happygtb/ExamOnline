...
/**
 * Servlet implementation class testQuestion
 */
@WebServlet("/testQuestion")
public class testQuestion extends HttpServlet {
	...
	request.setCharacterEncoding("utf-8");
		...
		String mySql = "select * from Question";
		...
		try {
			...
			while (rs.next()) {
				...
				jo.put("Diffculity", rs.getString("Diffculity"));
